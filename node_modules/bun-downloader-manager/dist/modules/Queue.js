...
class Queue {
    heap = []; // A heap to store tasks. This is a max-heap (higher priority tasks are at the root).
    activeCount = 0; // The number of active tasks currently being processed.
    concurrencyLimit; // The maximum number of concurrent tasks that can run at the same time.
    maxRetries; // The maximum number of retries allowed for failed tasks.
    log;
    constructor(concurrencyLimit, maxRetries, consoleLog) {
